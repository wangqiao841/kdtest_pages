...
* [正式版] `pip install kdtest==1.1.7`
* [测试版] `pip install -i https://test.pypi.org/simple/ kdtest==1.1.7`
* `pip install  C:/xxxxxx/kdtest-1.1.7-py3-none-any.whl`

你可以在控制台中键入 `kdtest -v` 来验证是否安装成功。
> 1.1.7为当前框架最新版本；推荐安装正式版
### 亮点
灵活、易用、成本低
### 框架特点
